...
function checkTime(senderID) {
  ...
  if (hour >= 21) {
    sendTextMessage(senderID, 'Good night, customer');
  }
}
        ...
        payload: {
          ...
          elements: [
            ...
            },
            {
              ...
              item_url:
                'https://www.mcdonalds.com/us/en-us/product/sweet-bbq-bacon-burger-on-sesame-seed-bun-202504.html',
              image_url:
                'http://static6.businessinsider.com/image/590cea94dd08959c288b4aeb-1207/sweet%20bbq%20mcdonalds%20bacon%20burger.png',
              buttons: [
                {
                  type: 'web_url',
                  url:
            ...
            },
            {
              ...
              item_url:
                'https://www.mcdonalds.com/us/en-us/product/sriracha-burger-on-artisan-roll.html',
              image_url:
                'http://del.h-cdn.co/assets/17/29/980x490/landscape-1500316280-sriracha-burger.png',
              buttons: [
                {
                  type: 'web_url',
                  url:
          ...
          elements: [
            {
              ...
              image_url:
                'http://s.eatthis-cdn.com/media/images/ext/907498607/mcdonalds-menu-dessert-shake-chocolate.jpg',
              buttons: [
                {
                  type: 'web_url',
                  url:
            ...
            },
            {
              ...
              image_url:
                'https://technabob.com/blog/wp-content/uploads/2017/03/mcdonalds_coke_1.jpg',
              buttons: [
                {
                  type: 'web_url',
                  url:
            ...
            },
            {
              ...
              item_url:
                'https://www.mcdonalds.com/us/en-us/product/strawberry-shake-small.html',
              image_url:
                'http://thatoregonlife.com/wp-content/uploads/2016/03/mccafe2.png',
              buttons: [
                {
                  type: 'web_url',
                  url:
...
function processPostback(event) {
  ...
  if (payload === 'Greeting') {
    ...
    sendMessage(senderId, {
      text: "Perhaps you don't love Big Mac. Please tell me what you like.",
    });
  } else if (payload === 'Exit BBQ') {
    sendMessage(senderId, {
      text:
        'Maybe Sweet BBQ Bacon is not for today. Please tell me what I should do next.',
    });
  } else if (payload === 'Exit Signature') {
    sendMessage(senderId, {
      text:
        'Signature Sriracha Burger might not be your favorite, but please tell me other options',
    });
    ...
    sendMessage(senderId, {
      text: 'Perhaps you want something else. Please tell me what you like.',
    });
  } else if (payload === 'Exit Coffee') {
    sendMessage(senderId, {
      text:
        "Perhaps you like to have something else. Please tell me what's next",
    });
  } else if (payload === 'Exit Strawberry') {
    sendMessage(senderId, {
      text:
        "I'm sorry. It might not your favorite, but we have different drink. Please type your interest",
    });
    ...
    price = 0;
    sendMessage(senderId, {
      text: "Don't worry. It will be void in your order.",
    });
  }
}
